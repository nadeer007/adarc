...
export default async function TopSection({
	...
	console.log(Product?.attachments, "iamgesfile");
	...
	return (
		<div className="xl:flex justify-between gap-[16px] relative">
			<div
				id="left-section"
				className=" flex flex-col overflow-x-hidden  pr-[12px] xl:max-w-[75%] xl:w-[75%] xl:min-w-[75%]">
          ...
          <div className=" xl:hidden h-full " id="right-section">
			...
			<div className="hidden  xl:block sticky top-[170px] z-30 h-full " id="right-section">
