        ...
        <div className=" mx-auto pb-5">
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/2 p-4">
              ...
              <div className="mt-4">
                <h2 className="text-2xl font-bold">THE POWER OF ONE</h2>
            ...
            <div className="w-full md:w-1/2 p-4">
              <div>
                <h2 className="text-2xl font-bold">OUR BEST PRODUCTS</h2>
                <p className="mt-2 text-gray-700">
      ...
      <div className="bg-gray-100 py-10">
        <div className=" mx-auto">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full md:w-2/3 p-4">
              <h2 className="text-2xl font-bold">BETTER TOGETHER</h2>
              <p className="mt-2 text-gray-700">
        ...
        <div className=" mx-auto">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full md:w-7/12 p-4">
              <h2 className="text-2xl font-bold">OUR POWERED BY MSI PCS</h2>
              <p className="mt-2 text-gray-700">
