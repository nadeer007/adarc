...
const BannerSection = async function() {
    ...
    return (
        <div className="my-8  w-full flex gap-6"
        //  style={{ height: 'calc(100vh - 290px)' }}
        >
            <div className="w-[25%] relative max-md:hidden">
                <MainMenu data={categories} />
            </div>
            <div className="w-[75%] max-md:w-[100%] h-full flex flex-col gap-4">
