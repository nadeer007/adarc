  ...
  return (
    ...
    <div>
        <div className='mb-[8px] '>
            <h2 className={cn('rubik_regular text-[22px] max-sm:text-[18px] text-left leading-[26px] text-gunmetal',actualPriceClass?? null)}> <span className={`${isHome ? 'text-[14px]': ''}`}>AED</span> {data?.current_price }</h2>
        </div>
